#############################################################################
# Makefile for building: algoritmo_srtn
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  algoritmo_srtn.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake QMAKE_CC=/usr/bin/gcc QMAKE_CXX=/usr/bin/g++ QMAKE_CFLAGS=-g3\ -gdwarf-2 QMAKE_CXXFLAGS=-g3\ -gdwarf-2 -o Makefile algoritmo_srtn.pro
#############################################################################
...
CXXFLAGS      = -g3 -gdwarf-2 -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		algoritmo_srtn.pro \
		algoritmo_srtn.pro
QMAKE_TARGET  = algoritmo_srtn
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = algoritmo_srtn
...
Makefile: algoritmo_srtn.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) QMAKE_CC=/usr/bin/gcc QMAKE_CXX=/usr/bin/g++ QMAKE_CFLAGS=-g3\ -gdwarf-2 QMAKE_CXXFLAGS=-g3\ -gdwarf-2 -o Makefile algoritmo_srtn.pro
...
dist: 
	@test -d .tmp/algoritmo_srtn1.0.0 || mkdir -p .tmp/algoritmo_srtn1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/algoritmo_srtn1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/algoritmo_srtn1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/algoritmo_srtn1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/algoritmo_srtn1.0.0/ && (cd `dirname .tmp/algoritmo_srtn1.0.0` && $(TAR) algoritmo_srtn1.0.0.tar algoritmo_srtn1.0.0 && $(COMPRESS) algoritmo_srtn1.0.0.tar) && $(MOVE) `dirname .tmp/algoritmo_srtn1.0.0`/algoritmo_srtn1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/algoritmo_srtn1.0.0
